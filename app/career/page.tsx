    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="relative z-20 text-center px-6 max-w-6xl mx-auto">
          <div className="mb-12">
            {/* Coming Soon Badge */}
            <div className="inline-flex items-center space-x-2 bg-yellow-400/10 border border-yellow-400/30 rounded-full px-6 py-3 mb-8">
              <Rocket className="w-5 h-5 text-yellow-400" />
              <span className="text-yellow-400 font-semibold text-sm tracking-wider uppercase">Coming Soon</span>
            </div>

            <h1
              className={`text-6xl md:text-8xl font-black mb-8 tracking-tight leading-none transition-all duration-1000 ${
            ...
            <p
              className={`text-gray-300 text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed font-light mb-12 transition-all duration-1000 delay-300 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
            >
            ...
            {/* Features Grid */}
            <div
              className={`grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-16 transition-all duration-1000 delay-500 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
            >
              <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-800/50 hover:border-yellow-400/30 transition-all duration-300">
                <div className="w-12 h-12 bg-yellow-400/20 rounded-full flex items-center justify-center mb-4 mx-auto">
                  <Rocket className="w-6 h-6 text-yellow-400" />
                </div>
                <h3 className="text-white font-bold text-lg mb-2">Innovation First</h3>
                <p className="text-gray-400 text-sm">Work on cutting-edge eVTOL technology that's changing the world</p>
              </div>
              ...
              <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-800/50 hover:border-yellow-400/30 transition-all duration-300">
                ...
                <h3 className="text-white font-bold text-lg mb-2">Amazing Team</h3>
                <p className="text-gray-400 text-sm">Join brilliant minds passionate about the future of mobility</p>
              </div>
              ...
              <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-800/50 hover:border-yellow-400/30 transition-all duration-300">
                ...
                <h3 className="text-white font-bold text-lg mb-2">Make Impact</h3>
                <p className="text-gray-400 text-sm">Shape the future of transportation and sustainable aviation</p>
              </div>
            </div>
            ...
            >
              ...
              <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-800/50 max-w-md mx-auto">
                <h3 className="text-white font-bold text-xl mb-4">Get Notified</h3>
                <p className="text-gray-400 text-sm mb-6">
                  Be the first to know when we start hiring. Send us your details at:
                </p>
                <div className="flex items-center justify-center space-x-3 bg-yellow-400/10 rounded-lg p-4 border border-yellow-400/30">
                  <Mail className="w-5 h-5 text-yellow-400 flex-shrink-0" />
                  <span className="text-yellow-400 font-semibold">khageshvaramobility@gmail.com</span>
                </div>
              </div>
            </div>
          </div>
